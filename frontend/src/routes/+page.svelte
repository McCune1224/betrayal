  ...
  <div class="mx-auto max-w-6xl">
    ...
    {:else if dashboard}
      <section class="grid gap-4 py-8 sm:grid-cols-3" aria-label="Game metrics">
        ...
        <article class="rounded border border-slate-800 bg-[#0d111b] p-5"><p class="text-xs uppercase tracking-wide text-slate-500">System</p><p class="mt-3 text-3xl font-semibold text-emerald-300">Ready</p><p class="mt-2 text-sm text-slate-400">Use healthcheck for detailed readiness</p></article>
      </section>
