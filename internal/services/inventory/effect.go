...
func (ih *InventoryHandler) AddEffect(effect string) error {
	...
	return ih.m.Inventories.UpdateEffects(ih.i)
}

func (ih *InventoryHandler) RemoveEffect(effect string) error {
