...
func (s *Server) setupRoutes() {
	...
	apiV1.DELETE("/players/:id", apiPlayersAdminHandler.Delete, apiAuthMiddleware.RequireAuth)
	...
	apiCatalog.POST("/roles/:id/abilities", apiCatalogHandler.RoleAddAbility)
	apiCatalog.DELETE("/roles/:id/abilities/:abilityID", apiCatalogHandler.RoleRemoveAbility)
	apiCatalog.POST("/roles/:id/perks", apiCatalogHandler.RoleAddPerk)
	apiCatalog.DELETE("/roles/:id/perks/:perkID", apiCatalogHandler.RoleRemovePerk)
	...
	apiCatalog.POST("/items/:id/categories", apiCatalogHandler.ItemAddCategory)
	apiCatalog.DELETE("/items/:id/categories/:categoryID", apiCatalogHandler.ItemRemoveCategory)
	...
	apiCatalog.POST("/abilities/:id/categories", apiCatalogHandler.AbilityAddCategory)
	apiCatalog.DELETE("/abilities/:id/categories/:categoryID", apiCatalogHandler.AbilityRemoveCategory)
	...
	apiCatalog.GET("/perks", apiCatalogHandler.ListPerks)
	apiCatalog.GET("/perks/search", apiCatalogHandler.ListPerks)
	apiCatalog.GET("/perks/:id", apiCatalogHandler.GetPerk)
	apiCatalog.POST("/perks", apiCatalogHandler.CreatePerk)
	apiCatalog.PUT("/perks/:id", apiCatalogHandler.UpdatePerk)
	apiCatalog.DELETE("/perks/:id", apiCatalogHandler.DeletePerk)
	apiCatalog.GET("/categories", apiCatalogHandler.ListCategories)
	apiCatalog.GET("/categories/search", apiCatalogHandler.ListCategories)
	apiCatalog.GET("/categories/:id", apiCatalogHandler.GetCategory)
	apiCatalog.POST("/categories", apiCatalogHandler.CreateCategory)
	apiCatalog.PUT("/categories/:id", apiCatalogHandler.UpdateCategory)
	apiCatalog.DELETE("/categories/:id", apiCatalogHandler.DeleteCategory)
